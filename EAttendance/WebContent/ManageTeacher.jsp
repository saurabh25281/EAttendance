...
<table width="750px" cellpadding='3' class='outter' height="300px">
      <tr>
         <th align="center" scope="col" >List Teacher</td>
      </tr>
	  <tr>
	  <td>
...
<s:if test="teacherList.size() > 0">
	...
	<table class="teacherTable" cellpadding="5px">
		...
		<s:iterator value="teacherList" status="teacherStatus">
			<tr
				...
				<td>
                <s:url id="editURL" action="editTeacher">
					<s:param name="teacher_id" value="%{teacher_id}"></s:param>
				</s:url>
                <s:a href="%{editURL}">Edit</s:a>
                </td>
				<td>
                <s:url id="deleteURL" action="deleteTeacher">
					<s:param name="teacher_id" value="%{teacher_id}"></s:param>
				</s:url>
