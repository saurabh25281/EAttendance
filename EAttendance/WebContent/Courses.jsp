...
<body bgcolor="#ffffff">
 <table width="100%" border="0" cellspacing="0">
		<tr><td align="center" class="labelHeader">Manage Courses</td></tr>
		<tr><td align="center" class="labelHeader">&nbsp;</td></tr>
		<tr><td class="label" align="left"><div id="divHead" name="divHead"></div></td></tr>		
	</table>
	<center>

<s:form action="saveOrUpdateCourse">
	<s:push value="course">
		<s:hidden name="id" />
		<s:textfield name="courseName" label="Course Name" placeholder="Course Name" />
		<s:textfield name="courseCode" label="Course Code" placeholder="Course Code" />
		<s:submit />
 </s:push>
...
<s:if test="courseList.size() > 0">
	...
	<table class="courseTable" cellpadding="5px">
		...
		<s:iterator value="courseList" status="courseStatus">
			<tr
				class="<s:if test="courseStatus.odd == true ">odd</s:if> <s:else>even</s:else>">
				<td><s:property value="courseName" /></td>
				<td><s:property value="courseCode" /></td>
				<td>
                <s:url id="editURL" action="editCourse">
