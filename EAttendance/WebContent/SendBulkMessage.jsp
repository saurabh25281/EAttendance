...
<table width="750px" cellpadding='3' class='outter' height="300px">
      <tr>
         <th align="center" scope="col" colspan="7"> Send Personal Message</td>
      </tr>
	  <tr>
	  <td>
...
<br>
<center>
<table ID="MediaTable" width="80%"  cellspacing="0" height="300px"  border="0">
<TR>
	<TD>Subject :</TD>
...
<TR>
	<TD>Message :</TD>
	<TD><TEXTAREA NAME="notice" ROWS="10" COLS="35"></TEXTAREA>
...
<TR>
	<TD>Date :</TD>
	<TD><INPUT TYPE="text" NAME="notice Date" size="20"></TD>
</TR>
<TR>
	<TD>Send to:(Upload comma seaperated contacts file)</TD>
	<TD><INPUT TYPE="File" NAME="notice Date" size="20"></TD>
</TR>

<TR>
	<TD><INPUT TYPE="button" value="Submit" class="minibtn"> </TD><TD><INPUT TYPE="button" value="Cancle" class="minibtn" ></TD>
</TR>
</TABLE>
</center>
</TABLE>
