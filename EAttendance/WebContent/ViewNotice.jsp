...
<table width="85%" cellpadding='0' class='outter' height="21%">
      <tr>
         <th align="center" scope="col" colspan="6"> Filter Notice</td>
      </tr>
	  <tr>
	  <td colspan="5">
...
<TR>
	...
	<tr >
         <th colspan="5" align="center" scope="col">Notice Board</td>
      </tr>
	 
	  
	<tr>
		<td width="5%">Id</td><td width="20%">Title</td><td width="50%">Notice</td><td width="10%">Date</td><td width="10%">Option</td>
	</tr>
<br>
<center>
</TABLE>
